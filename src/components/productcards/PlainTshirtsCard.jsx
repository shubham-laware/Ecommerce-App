...
function PlainTshirtsCard(){
    ...
    const sortedProducts=[...plainTshirtProducts].sort((a,b)=> (b.time)-(a.time))
    ...
    return (
        <div className='flex flex-col '>
             ...
             <div className=' px-2 md:mx-20'>
                <h2 className='font-medium text-center sm:text-start  text-xl sm:text-2xl'>Plain T-shirts</h2>
            </div>
...
export default PlainTshirtsCard