...
function SweatShirtCards() {
    ...
    const sortedProducts = [...sweatShirtProducts].sort((a, b) => (b.time) - (a.time))
    ...
    return (
        <div className='flex flex-col  '>
            ...
            <div className=' px-2 md:mx-20'>
                <h2 className='font-medium  text-xl text-center sm:text-start sm:text-2xl'>Sweatshirts</h2>
            </div>
...
export default SweatShirtCards;